...
typedef enum _EMessageId
{
    ...
    EMessageId_StartReferenceThermocoupleTemperatureStabilizationRequest    = 35,
    EMessageId_StartReferenceThermocoupleTemperatureStabilizationResponse   = 36,
    EMessageId_StopReferenceThermocoupleTemperatureStabilizationRequest     = 37,
    EMessageId_StopReferenceThermocoupleTemperatureStabilizationResponse    = 38,
